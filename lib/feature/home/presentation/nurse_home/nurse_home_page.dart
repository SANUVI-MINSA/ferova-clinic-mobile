...
class _NurseHomePageState extends State<NurseHomePage> {
  ...
  void _navigateToRiskPatients(BuildContext context, String riskLevel) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => RiskPatientsPage(riskLevel: riskLevel),
      ),
    );
  }
      ...
      child: Column(
        ...
        children: [
          ...
          _buildRiskCard(
            ...
            onTap: () =>
                _navigateToRiskPatients(context, 'HIGH'), // ✅ NAVEGACIÓN
          ),
          ...
          _buildRiskCard(
            ...
            onTap: () =>
                _navigateToRiskPatients(context, 'MEDIUM'), // ✅ NAVEGACIÓN
          ),
          const SizedBox(height: 10),
          _buildRiskCard(
            label: 'LOW',
            ...
            onTap: () =>
                _navigateToRiskPatients(context, 'LOW'), // ✅ NAVEGACIÓN
          ),
        ],
      ),
    );
